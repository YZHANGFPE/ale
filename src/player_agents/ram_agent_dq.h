...
#ifndef RAM_AGENT_DQ_H
#define RAM_AGENT_DQ_H

#include "common_constants.h"
#include "player_agent.h"
#include "rl_ql_lambda.h"

class RAMAgentDQ : public PlayerAgent {
    /* *************************************************************************
        ...
        - p_ql_lambda_solver    Pointer to the Q-learning-Lambda solver object
    ...
    ************************************************************************* */
    ...
    public:
        ...
        RAMAgentDQ(GameSettings* _game_settings, OSystem* _osystem);
        virtual ~RAMAgentDQ();
