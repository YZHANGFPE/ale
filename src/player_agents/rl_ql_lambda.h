...
#ifndef RL_QL_LAMBDA_H
#define RL_QL_LAMBDA_H
...
class RLQlLambda {
    public:
        /* *********************************************************************
            Constructor
         ******************************************************************** */
       RLQlLambda(OSystem* _osystem, int feature_vec_size, 
        ...
        /* *********************************************************************
             One step of the main Q-learning(lambda) algorithm:
                new_features_map: s'
                new_reward: r'
        ...
        ******************************************************************** */
        static RLQlLambda* generate_rl_ql_lambda_instance(
...
class RLQlLambdaWithIDBD : public RLQlLambda {
	/* *************************************************************************
    ...
    public:
        /* *********************************************************************
            Constructor
         ******************************************************************** */
        RLQlLambdaWithIDBD(	OSystem* _osystem, int feature_vec_size, 
								int num_actions,  
								int save_weights_freq) ;
        /* *********************************************************************
            Deconstructor
         ******************************************************************** */
        virtual ~RLQlLambdaWithIDBD();
...
class RLQlLambdaWithDeltaBarDelta : public RLQlLambda {
    ...
    public:
        /* *********************************************************************
            Constructor
         ******************************************************************** */
        RLQlLambdaWithDeltaBarDelta(	OSystem* _osystem, int feature_vec_size, 
        ...
        /* *********************************************************************
            Deconstructor
         ******************************************************************** */
        virtual ~RLQlLambdaWithDeltaBarDelta();
