...
#ifndef RL_CB_LAMBDA_H
#define RL_CB_LAMBDA_H
...
class RLCBLambda {
    public:
        /* *********************************************************************
            Constructor
         ******************************************************************** */
       RLCBLambda(OSystem* _osystem, int feature_vec_size, 
        ...
        ******************************************************************** */
        static RLCBLambda* generate_rl_cb_lambda_instance(
...
class RLCBLambdaWithIDBD : public RLCBLambda {
	/* *************************************************************************
    ...
    public:
        /* *********************************************************************
            Constructor
         ******************************************************************** */
        RLCBLambdaWithIDBD(	OSystem* _osystem, int feature_vec_size, 
								int num_actions,  
								int save_weights_freq) ;
        /* *********************************************************************
            Deconstructor
         ******************************************************************** */
        virtual ~RLCBLambdaWithIDBD();
...
class RLCBLambdaWithDeltaBarDelta : public RLCBLambda {
    ...
    public:
        /* *********************************************************************
            Constructor
         ******************************************************************** */
        RLCBLambdaWithDeltaBarDelta(	OSystem* _osystem, int feature_vec_size, 
        ...
        /* *********************************************************************
            Deconstructor
         ******************************************************************** */
        virtual ~RLCBLambdaWithDeltaBarDelta();
