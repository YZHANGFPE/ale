 ...
 *  ram_agent_cb.cpp
 *
 *  The implementation of the RAMAgentCB class, which is a generic player 
...
RAMAgentCB::RAMAgentCB(GameSettings* _game_settings, OSystem* _osystem) :
	...
	p_cb_lambda_solver = RLCBLambda::generate_rl_cb_lambda_instance(
...
******************************************************************** */
Action RAMAgentCB::on_start_of_game(void) {
    generate_feature_vec();
 ...
 ******************************************************************** */
void RAMAgentCB::on_end_of_game(void) {
 ...
 ******************************************************************** */
void RAMAgentCB::generate_feature_vec(void) {
    for (int a = 0; a < i_num_actions; a++) {
