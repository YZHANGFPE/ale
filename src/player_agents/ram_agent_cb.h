...
class RAMAgentCB : public PlayerAgent {
    /* *************************************************************************
        ...
        - p_cb_lambda_solver    Pointer to the Q-learning-Lambda solver object
    ...
    ************************************************************************* */
    ...
    public:
        ...
        RAMAgentCB(GameSettings* _game_settings, OSystem* _osystem);
        virtual ~RAMAgentCB();
