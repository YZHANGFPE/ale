 ...
 *  ram_agent_dq.cpp
 *
 *  The implementation of the RAMAgentDQ class, which is a generic player 
...
RAMAgentDQ::RAMAgentDQ(GameSettings* _game_settings, OSystem* _osystem) :
 ...
 ******************************************************************** */
Action RAMAgentDQ::agent_step(const IntMatrix* screen_matrix, 
...
******************************************************************** */
Action RAMAgentDQ::on_start_of_game(void) {
    generate_feature_vec();
 ...
 ******************************************************************** */
void RAMAgentDQ::on_end_of_game(void) {
 ...
 ******************************************************************** */
void RAMAgentDQ::generate_feature_vec(void) {
    for (int a = 0; a < i_num_actions; a++) {
